...
INSERT INTO `jugadores` (`id_player`, `id_eqipo`, `nombre`, `posicion`, `equipo`, `edad`, `altura`, `peso`) VALUES
	...
	(76, 16, 'Axel Witsel', 'DF', 'Atlético de Madrid', 35, 1.86, 73),
	(77, 11, 'Andoni Gorosabel', 'DF', 'Alavés', 27, 1.74, NULL),
	...
	(219, 1, 'Jonathan Viera', 'MC', 'Almería', 34, 1.71, 65),
	...
	(224, 9, 'Íñigo Lekue', 'DF', 'Athletic Club', 30, 1.8, 73),
	...
	(314, NULL, 'Sergi Roberto', 'DF', 'Barcelona', 32, 1.78, 68),
	...
	(352, NULL, 'Carlos Dotor', 'MC', 'Celta de Vigo', 23, 1.8, 68),
	(353, NULL, 'Carlos Dotor', 'MC', 'Celta de Vigo', 23, 1.8, 68),
	(354, NULL, 'Benito Ramírez', 'MC', 'Las Palmas', 28, 1.8, NULL),
	(355, NULL, 'Ramón Terrats', 'MC', 'Villarreal', 23, 1.79, NULL),
	(356, NULL, 'Cenk Özkacar', 'DF', 'Valencia', 23, 1.9, NULL),
	(357, 14, ' Juanpe', 'DF', 'Girona', 32, 1.89, 85),
	(358, NULL, 'César Montes', 'DF', 'Almería', 27, 1.95, 70),
	(359, NULL, 'Jorge Herrando', 'DF', 'Osasuna', 23, 1.92, NULL),
	(360, NULL, 'Javi Llabrés', 'DL', 'Mallorca', 21, 1.74, NULL),
	(361, 11, 'Sory Kaba', 'DL', 'Las Palmas', 28, 1.91, NULL),
	(362, NULL, 'Selim Amallah', 'MC', 'Valencia', 27, 1.87, NULL),
	(363, NULL, 'Sergi Guardiola', 'DL', 'Cádiz', 32, 1.85, 77),
	(364, NULL, 'Aritz Elustondo', 'DF', 'Real Sociedad', 29, 1.78, 72),
	(365, NULL, 'Nacho Vidal', 'DF', 'Mallorca', 29, 1.8, NULL),
	(366, NULL, 'André Silva', 'DL', 'Real Sociedad', 28, 1.85, 79),
	(367, NULL, 'Pep Chavarría', 'DF', 'Rayo Vallecano', 25, 1.74, NULL),
	(368, 10, 'Kike Barja', 'MC', 'Osasuna', 26, 1.78, 69),
	(369, NULL, 'Álex Pozo', 'DF', 'Almería', 25, 1.74, NULL),
	(370, NULL, 'Sergi Altimira', 'MC', 'Betis', 22, 1.88, NULL),
	(371, NULL, 'Randy Nteka', 'DL', 'Rayo Vallecano', 26, 1.9, NULL),
	(372, 18, 'Bruno Méndez', 'DF', 'Granada', 24, 1.84, NULL),
	(373, NULL, 'Vitor Roque', 'DL', 'Barcelona', 19, 1.72, 76),
	(374, NULL, 'Carles Pérez', 'MC', 'Celta de Vigo', 26, 1.72, NULL),
	(375, 8, 'Iván Villar', 'PT', 'Celta de Vigo', 26, 1.83, 76),
	(376, NULL, 'Rafa Mir', 'DL', 'Sevilla', 26, 1.89, 87),
	(377, 13, 'Asier Villalibre', 'DL', 'Athletic Club', 26, 1.83, 80),
	(378, 3, 'Facundo Pellistri', 'DL', 'Granada', 22, 1.74, NULL),
	(379, NULL, 'Franco Cervi', 'MC', 'Celta de Vigo', 29, 1.65, 62),
	(380, NULL, 'Raúl Torrente', 'DF', 'Granada', 22, 1.93, NULL),
	(381, 5, 'Claudio Bravo', 'PT', 'Betis', 40, 1.85, 80),
	(382, 18, 'Jon Ander Olasagasti', 'MC', 'Real Sociedad', 23, 1.69, NULL),
	(383, NULL, 'Luka Romero', 'MC', 'Almería', 19, 1.65, NULL),
	(384, 1, 'Aleksandar Radovanovic', 'DF', 'Almería', 30, 1.89, NULL),
	(385, NULL, 'André Almeida', 'MC', 'Valencia', 23, 1.76, 62),
	(386, 4, 'Jordi Martín', 'MC', 'Getafe', 23, 1.74, NULL),
	(387, 12, 'Yéremi Pino', 'DL', 'Villarreal', 21, 1.72, NULL),
	(388, NULL, 'Jorge Meré', 'DF', 'Cádiz', 26, 1.82, 78),
	(389, NULL, 'Kevin Vázquez', 'DF', 'Celta de Vigo', 31, 1.73, NULL),
	(390, 16, 'Raúl García', 'DL', 'Athletic Club', 37, 1.84, 84),
	(391, NULL, 'Miguel Crespo', 'MC', 'Rayo Vallecano', 27, 1.87, 73),
	(392, NULL, 'Eric Bailly', 'DF', 'Villarreal', 29, 1.87, 77),
	(393, NULL, 'Alex Centelles', 'DF', 'Almería', 24, 1.85, NULL),
	(394, NULL, 'Manu Trigueros', 'MC', 'Villarreal', 32, 1.78, 71),
	(395, 3, 'Youssouf Sabaly', 'DF', 'Betis', 31, 1.74, 70),
	(396, NULL, 'Jon Aramburu', 'DF', 'Real Sociedad', 21, 1.74, 71),
	(397, NULL, 'Yerson Mosquera', 'DF', 'Villarreal', 22, 1.88, NULL),
	(398, NULL, 'Mauro Arambarri', 'MC', 'Getafe', 28, 1.75, 76),
	(399, NULL, 'Malcom Adu Ares', 'DL', 'Athletic Club', 22, 1.83, 183),
	(400, NULL, 'Dani Ceballos', 'MC', 'Real Madrid', 27, 1.79, 65),
	(401, NULL, 'Jhon Solís', 'MC', 'Girona', 19, 1.86, NULL),
	(402, NULL, 'Choco Lozano', 'DL', 'Almería', 30, 1.83, 79),
	(403, NULL, 'Choco Lozano', 'DL', 'Almería', 30, 1.83, 79),
	(404, 6, 'Juanma Herzog', 'DF', 'Las Palmas', 19, 1.86, NULL),
	(405, 18, 'Sheraldo Becker', 'DL', 'Real Sociedad', 29, 1.8, 75),
	(406, NULL, 'Javier Manquillo', 'DF', 'Celta de Vigo', 29, 1.8, 62),
	(407, NULL, 'Marko Milovanovic', 'DL', 'Almería', 20, 1.96, NULL),
	(408, NULL, 'Domingos Duarte', 'DF', 'Getafe', 29, 1.91, 83),
	(409, 1, 'Bertrand Traoré', 'DL', 'Villarreal', 28, 1.8, 72),
	(410, 3, 'Tadeo Allende', 'DL', 'Celta de Vigo', 25, 1.85, NULL),
	(411, NULL, 'Andrei Rațiu', 'DF', 'Rayo Vallecano', 25, 1.83, NULL),
	(412, NULL, ' Jailson', 'MC', 'Celta de Vigo', 28, 1.87, 74),
	(413, NULL, 'Adrià Altimira', 'DF', 'Villarreal', 22, 1.7, NULL),
	(414, 6, 'Yellu Santiago', 'MC', 'Getafe', 19, 1.92, NULL),
	(415, 14, 'Joseph Aidoo', 'DF', 'Celta de Vigo', 28, 1.84, 80),
	(416, NULL, 'Martin Hongla', 'MC', 'Granada', 26, 1.83, NULL),
	(417, NULL, 'Matías Arezo', 'DL', 'Granada', 21, 1.78, 76),
	(418, NULL, 'Brian Ocampo', 'MC', 'Cádiz', 24, 1.73, 70),
	(419, NULL, 'Arda Güler', 'MC', 'Real Madrid', 19, 1.76, NULL),
	(420, NULL, 'Carlos Romero', 'DF', 'Villarreal', 22, 0, NULL),
	(421, NULL, 'Unai García', 'DF', 'Osasuna', 31, 1.82, 81),
	(422, NULL, 'Cristian Herrera', 'DL', 'Las Palmas', 33, 1.89, 85),
	(423, NULL, 'Xeber Alkain', 'MC', 'Alavés', 26, 1.74, NULL),
	(424, NULL, 'Yarek Gasiorowski', 'DF', 'Valencia', 19, 1.9, NULL),
	(425, NULL, 'Imanol García', 'DF', 'Athletic Club', 23, 1.77, NULL),
	(426, NULL, 'Fran Vieites', 'PT', 'Betis', 24, 1.96, NULL),
	(427, 16, 'Ilaix Moriba', 'MC', 'Getafe', 21, 1.83, NULL),
	(428, NULL, 'Peter Federico', 'DL', 'Valencia', 21, 1.78, NULL),
	(429, NULL, 'Aitor Fernández', 'PT', 'Osasuna', 32, 1.82, 78),
	(430, NULL, 'Joseba Zaldua', 'DF', 'Cádiz', 31, 1.76, 70),
	(431, 14, 'Miguel Rodríguez', 'DL', 'Celta de Vigo', 20, 1.79, NULL),
	(432, NULL, 'Marc Guiu', 'DL', 'Barcelona', 18, 1.87, NULL),
	(433, NULL, 'Hector Fort', 'DF', 'Barcelona', 17, 1.85, 77),
	(434, NULL, 'Nemanja Radonjić', 'DL', 'Mallorca', 28, 1.85, 76),
	(435, 12, 'Momo Mbaye', 'DF', 'Cádiz', 25, 1.88, NULL),
	(436, NULL, 'Raúl Fernández', 'PT', 'Granada', 36, 1.96, 88),
	(437, NULL, 'Jon Magunazelaia', 'DL', 'Real Sociedad', 22, 1.8, NULL),
	(438, NULL, 'Tanguy Nianzou', 'DF', 'Sevilla', 21, 1.92, 83),
	(439, NULL, 'Alberto Marí', 'DL', 'Valencia', 22, 1.83, NULL),
	(440, NULL, 'Ibrahima Koné', 'DL', 'Almería', 24, 1.9, NULL),
	(441, NULL, 'Siebe Van der Heyden', 'DF', 'Mallorca', 25, 1.85, NULL),
	(442, NULL, 'Adnan Januzaj', 'MC', 'Sevilla', 29, 1.86, 75),
	(443, NULL, 'Marcos Alonso', 'DF', 'Barcelona', 33, 1.88, 84),
	(444, 16, 'Joan Jordan', 'MC', 'Sevilla', 29, 1.84, 74),
	(445, NULL, 'Hugo González', 'MC', 'Valencia', 21, 1.81, NULL),
	(446, NULL, 'Hugo Álvarez', 'MC', 'Celta de Vigo', 20, 1.76, NULL),
	(447, NULL, 'Faitout Maouassa', 'DF', 'Granada', 25, 1.72, 74),
	(448, 6, ' Marcão', 'DF', 'Sevilla', 27, 1.85, 75),
	(449, NULL, 'Giuliano Simeone', 'DL', 'Alavés', 21, 1.78, NULL),
	(450, NULL, 'Mariano Díaz', 'DL', 'Sevilla', 30, 1.8, 79),
	(451, NULL, 'Lucien Agoumé', 'MC', 'Sevilla', 22, 1.85, NULL),
	(452, NULL, 'Álvaro Lemos', 'DF', 'Las Palmas', 30, 1.75, NULL),
	(453, NULL, 'Denis Suárez', 'MC', 'Villarreal', 30, 1.76, 69),
	(454, 18, 'Pablo Gozálbez', 'MC', 'Valencia', 22, 1.7, NULL),
	(455, NULL, 'Fabrizio Angileri', 'DF', 'Getafe', 30, 1.85, 84),
	(456, NULL, 'Aiham Ousou', 'DF', 'Cádiz', 24, 1.86, NULL),
	(457, NULL, 'Mikel Jauregizar', 'MC', 'Athletic Club', 20, 1.77, NULL),
	(458, 12, 'Urko González', 'MC', 'Real Sociedad', 23, 1.89, NULL),
	(459, 12, 'Fede San Emeterio', 'MC', 'Cádiz', 27, 1.74, 68),
	(460, NULL, 'Theo Corbeanu', 'DL', 'Granada', 21, 1.9, NULL),
	(461, NULL, 'José Campaña', 'MC', 'Las Palmas', 30, 1.79, 72),
	(462, NULL, 'Álvaro Odriozola', 'DF', 'Real Sociedad', 28, 1.75, 74),
	(463, NULL, 'Kamil Jóźwiak', 'MC', 'Granada', 25, 1.76, 70),
	(464, NULL, 'Omenuke Mfulu', 'MC', 'Las Palmas', 30, 1.82, 70),
	(465, NULL, 'Bruno Langa', 'DF', 'Almería', 26, 1.78, NULL),
	(466, NULL, 'Ricardo Visus', 'DF', 'Betis', 22, 1.92, NULL),
	(467, NULL, 'Arthur Vermeeren', 'MC', 'Atlético de Madrid', 19, 1.8, NULL),
	(468, NULL, 'Jesús Vallejo', 'DF', 'Granada', 27, 1.84, 74),
	(469, 11, 'Víctor Díaz', 'DF', 'Granada', 35, 1.83, 72),
	(470, 4, 'Éder Militão', 'DF', 'Real Madrid', 26, 1.86, 78),
	(471, NULL, 'Diadié Samassékou', 'MC', 'Cádiz', 28, 1.75, 67),
	(472, NULL, 'Alejo Véliz', 'DL', 'Sevilla', 20, 1.87, 77),
	(473, NULL, 'Marc Bartra', 'DF', 'Betis', 33, 1.83, 73),
	(474, NULL, 'Hannibal Mejbri', 'MC', 'Sevilla', 21, 1.82, NULL),
	(475, NULL, 'Marcos Pena', 'MC', 'Almería', NULL, NULL, NULL),
	(476, NULL, 'Antal Yaakobishvili', 'DF', 'Girona', 19, 1.93, NULL),
	(477, NULL, 'Diego Hormigo', 'DF', 'Sevilla', 20, 1.82, NULL),
	(478, NULL, 'Unai Marrero', 'PT', 'Real Sociedad', 22, 1.87, NULL),
	(479, NULL, 'Mario Dominguez', 'MC', 'Valencia', 20, 1.75, NULL),
	(480, NULL, 'Diego Mariño', 'PT', 'Almería', 33, 1.87, 75),
	(481, NULL, 'Pepe Reina', 'PT', 'Villarreal', 41, 1.88, 92),
	(482, NULL, 'Pablo Busto', 'DF', 'Betis', 18, 1.8, NULL),
	(483, 11, 'José Mari', 'MC', 'Cádiz', 36, 1.81, 75),
	(484, NULL, 'Fernando Martínez', 'PT', 'Almería', 33, 1.85, 79),
	(485, 6, 'Kamil Piatkowski', 'DF', 'Granada', 23, 1.91, NULL),
	(486, NULL, 'Cédric Bakambu', 'DL', 'Betis', 32, 1.82, 73),
	(487, 17, 'Eric Curbelo', 'DF', 'Las Palmas', 30, 1.81, NULL),
	(488, NULL, 'Etta Eyong', 'MC', 'Cádiz', 20, 0, NULL),
	(489, NULL, 'Damián Rodríguez', 'MC', 'Celta de Vigo', NULL, NULL, NULL),
	(490, 16, 'Diego Mendez', 'MC', 'Rayo Vallecano', 20, 1.82, NULL),
	(491, 16, 'Gonzalo García', 'DL', 'Real Madrid', 20, 1.82, NULL),
	(492, NULL, 'Nico Paz', 'MC', 'Real Madrid', 19, 1.85, NULL),
	(493, NULL, 'Thomas Lemar', 'MC', 'Atlético de Madrid', 28, 1.7, 58),
	(494, NULL, 'Víctor Parada', 'DF', 'Alavés', 21, 1.84, NULL),
	(495, NULL, 'Alberto Dadie', 'DL', 'Real Sociedad', 21, 1.7, NULL),
	(496, NULL, 'Joaquín Panichelli', 'DL', 'Alavés', 21, 1.86, 82),
	(497, 17, 'José Ángel Pozo', 'MC', 'Rayo Vallecano', 28, 1.7, 60),
	(498, NULL, 'Silvi Clúa', 'MC', 'Girona', 19, 0, NULL),
	(499, NULL, 'Fabio González', 'MC', 'Las Palmas', 27, 1.76, NULL),
	(500, 4, 'Thibaut Courtois', 'PT', 'Real Madrid', 31, 2, 94),
	(501, NULL, 'Álvaro Rodríguez', 'DL', 'Real Madrid', 19, 1.93, NULL),
	(502, 13, 'Daniel Fuzato', 'PT', 'Getafe', 26, 1.9, NULL),
	(503, 13, 'Daniel Fuzato', 'PT', 'Getafe', 26, 1.9, NULL),
	(504, 16, 'Pichu Cuéllar', 'PT', 'Mallorca', 39, 1.87, 76),
	(505, 14, 'Julen Agirrezabala', 'PT', 'Athletic Club', 23, 1.87, NULL),
	(506, NULL, 'Unai Ropero', 'MC', 'Alavés', 22, 1.88, NULL),
	(507, 13, 'Martín Pascual', 'DF', 'Rayo Vallecano', 24, 1.9, NULL),
	(508, NULL, 'Alberto Flores', 'PT', 'Sevilla', 20, 1.87, NULL),
	(509, NULL, 'Adama Boiro', 'DF', 'Athletic Club', 21, 1.82, NULL),
	(510, 14, ' Vitolo', 'MC', 'Atlético de Madrid', 34, 1.85, 80),
	(511, NULL, 'Aarón Escandell', 'PT', 'Las Palmas', 28, 1.88, 73),
	(512, 16, 'Dominik Greif', 'PT', 'Mallorca', 26, 1.97, 82),
	(513, 12, 'Jesús Owono', 'PT', 'Alavés', 23, 1.81, 67),
	(514, 11, 'Juan Carlos Martín', 'PT', 'Girona', 36, 1.87, 81),
	(515, NULL, 'Borja García', 'MC', 'Girona', 33, 1.75, 65),
	(516, NULL, 'Cristian Rivero', 'PT', 'Valencia', 26, 1.88, NULL),
	(517, 18, 'Dani Cárdenas', 'PT', 'Rayo Vallecano', 26, 1.85, NULL),
	(518, NULL, 'Horațiu Moldovan', 'PT', 'Atlético de Madrid', 26, 1.82, NULL),
	(519, NULL, 'Jastin García', 'DL', 'Girona', 20, 1.8, NULL),
	(520, 17, 'Jaume Doménech', 'PT', 'Valencia', 33, 1.86, 73),
	(521, NULL, 'Julen Jon Guerrero', 'MC', 'Alavés', NULL, NULL, NULL),
	(522, NULL, 'Marc Martínez', 'PT', 'Granada', 33, 1.85, 74),
	(523, NULL, 'Martín Merquelanz', 'MC', 'Real Sociedad', 28, 1.76, NULL),
	(524, NULL, 'Martín Tejón', 'MC', 'Valencia', 19, 1.65, NULL),
	(525, 18, 'Pablo Marín', 'MC', 'Real Sociedad', 20, 1.78, NULL),
	(526, NULL, 'Toni Fuidias', 'PT', 'Girona', 22, 1.95, NULL),
	(527, 17, 'Toni Villa', 'MC', 'Girona', 29, 1.71, 63),
	(528, NULL, 'Daley Sinkgraven', 'DF', 'Las Palmas', 28, 1.79, 65);
